...
import org.jkiss.dbeaver.ext.flink.model.FlinkIndex;
...
public class FlinkTableManager extends GenericTableManager implements DBEObjectRenamer<GenericTableBase> {

    private static final Class<? extends DBSObject>[] CHILD_TYPES = CommonUtils.array(
            FlinkTableColumn.class,
    ...
    public Collection<? extends DBSObject> getChildObjects(DBRProgressMonitor monitor, GenericTableBase object, Class<? extends DBSObject> childType) throws DBException {
        if (childType == FlinkTableColumn.class) {
            return object.getAttributes(monitor);
        } else if (childType == FlinkIndex.class) {
    ...
    public boolean canDeleteObject(@NotNull GenericTableBase object) {
        return !((FlinkTable)object).isIndexTable();
    }

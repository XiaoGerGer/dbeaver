 ...
 */
package org.jkiss.dbeaver.ext.flink.model.edit;

import org.jkiss.code.NotNull;
import org.jkiss.dbeaver.DBException;
import org.jkiss.dbeaver.Log;
import org.jkiss.dbeaver.ext.flink.model.FlinkTable;
import org.jkiss.dbeaver.ext.flink.model.FlinkTableColumn;
...
/**
 * FlinkTableColumnManager
 */
public class FlinkTableColumnManager extends GenericTableColumnManager {

    private static final Log log = Log.getLog(FlinkTableColumnManager.class);
    ...
    protected void addObjectCreateActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull ObjectCreateCommand command, @NotNull Map<String, Object> options) {
        FlinkTable table = (FlinkTable) command.getObject().getParentObject();
        actions.add(
    ...
    protected void addObjectDeleteActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull ObjectDeleteCommand command, @NotNull Map<String, Object> options) throws DBException {
        FlinkTableColumn FlinkTableColumn = (FlinkTableColumn) command.getObject();
        FlinkTable table = (FlinkTable) FlinkTableColumn.getParentObject();
        try {

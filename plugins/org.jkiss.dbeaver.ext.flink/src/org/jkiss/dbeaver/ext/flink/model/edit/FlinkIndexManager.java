...
public class FlinkIndexManager extends GenericIndexManager {
    ...
    protected GenericTableIndex createDatabaseObject(@NotNull DBRProgressMonitor monitor, @NotNull DBECommandContext context, Object container, Object from, @NotNull Map<String, Object> options) {
        return new FlinkIndex((FlinkTable) container, "NewIndex", false, "", "Compact", null);
    }

    @Override
    protected void addObjectCreateActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext, @NotNull List<DBEPersistAction> actions, @NotNull ObjectCreateCommand command, @NotNull Map<String, Object> options) {
        FlinkIndex tableIndex = (FlinkIndex) command.getObject();
